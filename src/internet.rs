...
pub fn is_email(value: &str, whitelist: Option<Vec<&str>>) -> bool {
    ...
    //! #// Example Usage
    //! ```rust
    //! use validaten::internet::is_email;
    //!
    //! fn main() {
    //!     assert!(is_email("me@abc.com", None));
    //! }
    //! ```
    ...
    EMAIL_DOMAIN.is_match(&domain_part) ||
...
pub fn is_domain(value: &str) -> bool {
    ...
    //! #// Example Usage
    //! ```rust
    //! use validaten::internet::is_domain;
    //!
    //! fn main() {
    //!     assert!(is_domain("abc.com"));
    //! }
    //! ```
